...
public class DeptUserService extends MyBaseService {
    ...
    public Result findApplySuc(String userId) {
        String columnSql = "select du.realName userName,currentStatus,status,roleType,du.createDate,du.deptId companyId,concat(floor,'层',dept_name) companyName, d.dept_name sectionName ";
